...
import com.project.twitch.db.FavoriteRecordRepository;
import com.project.twitch.db.ItemRepository;
import com.project.twitch.db.UserRepository;
import com.project.twitch.db.entity.FavoriteRecordEntity;
import com.project.twitch.db.entity.ItemEntity;
import com.project.twitch.db.entity.UserEntity;
import com.project.twitch.external.TwitchService;
import com.project.twitch.external.model.Clip;
import com.project.twitch.external.model.Game;
import com.project.twitch.external.model.Stream;
import com.project.twitch.external.model.Video;
import com.project.twitch.model.ItemType;
...
//        logger.info("Item1exists: " + item1Exists); //Item1exists: true
//        logger.info("Item100exists: " + item100Exists); //Item100exists: false
//
